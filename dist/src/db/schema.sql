-- SQLite schema for HR Management System (source of truth for SQLite mode)
-- Tables created by migrations (report_templates, email_logs, etc.) are NOT listed here.
