...
export function createApp() {
    ...
    // Logging
    morgan.token('req-id', (req) => req.id?.slice(0, 8) || '-');
        ...
        try {
            ...
            if (webOut) {
                ...
                app.get('*', (req, res, next) => {
                    if (req.path.startsWith('/api') || req.path.startsWith('/socket.io') || req.path.startsWith('/health') || req.path.startsWith('/ready') || req.path.startsWith('/api-docs'))
                        return next();
